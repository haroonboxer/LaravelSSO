                              ...
                              function r() {
                                  ...
                                  return (
                                      ...
                                      !(
                                          ...
                                          ((u = i.settings.submitHandler.call(
                                              i,
                                              i.currentForm,
                                              t
                                          )),
            ...
            prototype: {
                init: function () {
                    function i(t) {
                        var e =
                            "undefined" !=
                                typeof n(this).attr("contenteditable") &&
                            "false" !== n(this).attr("contenteditable");
                        if (
                            (!this.form &&
                                e &&
                ...
                form: function () {
                    return (
                        ...
                        this.valid() ||
                            n(this.currentForm).triggerHandler("invalid-form", [
                                this,
                            ]),
                        this.showErrors(),
                        this.valid()
                ...
                checkForm: function () {
                    ...
                    for (
                        ...
                        if (
                            this.findByName(t[n].name).length != undefined &&
                            this.findByName(t[n].name).length > 1
                        )
                            for (
                                i = 0;
                                i < this.findByName(t[n].name).length;
                                i++
                            )
                                this.check(this.findByName(t[n].name)[i]);
                        else this.check(t[n]);
                    return this.valid();
                },
                element: function (t) {
                            ...
                            : (this.prepareElement(r),
                              ...
                              o &&
                                  n.each(this.groups, function (n, t) {
                                      t === o &&
                                          n !== r.name &&
                                          ((i = u.validationTargetFor(
                                              u.clean(u.findByName(n))
                                          )),
                                          i &&
                                              i.name in u.invalid &&
                                              (u.currentElements.push(i),
                                              (f = u.check(i) && f)));
                                  }),
                              (e = this.check(r) !== !1),
                              (f = f && e),
                ...
                elementValue: function (t) {
                    var i,
                        ...
                        f = t.type,
                        e =
                            "undefined" != typeof u.attr("contenteditable") &&
                            "false" !== u.attr("contenteditable");
                    return "radio" === f || "checkbox" === f
                        ? this.findByName(t.name).filter(":checked").val()
                        : "number" === f && "undefined" != typeof t.validity
                        ? t.validity.badInput
                            ? "NaN"
                            : u.val()
                        : ((i = e ? u.text() : u.val()),
            ...
            methods: {
                ...
                remote: function (t, i, r, u) {
                    ...
                    return (
                        ...
                        (e.originalMessage =
                            e.originalMessage ||
                            this.settings.messages[i.name][u]),
